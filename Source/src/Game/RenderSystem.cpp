...
void RenderSystem::renderEntity( Engine::Entity &entity )
{
    ...
    b2Vec2 pos = physComp.getBody()->GetPosition();
    GLfloat width = physComp.getWidth(), height = physComp.getHeight();
    
    transMatrix = glm::translate( glm::mat4( 1.0f ), glm::vec3( pos.x, pos.y, 0 ) );
    rotationMatrix = glm::rotate( glm::mat4( 1.0f ), glm::degrees( physComp.getBody()->GetAngle() ), glm::vec3( 0, 0, 1 ) );
